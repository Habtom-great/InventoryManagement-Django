...
class PurchaseDetailsForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['eway','veh', 'destination', 'po', 'cgst', 'sgst', 'igst', 'tin', 'cess', 'tcs', 'total']
...
class SupplierForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['tin'].widget.attrs.update({'class': 'textinput form-control', 'maxlength': '15', 'pattern' : '[A-Z0-9]{10}', 'title' : 'TIN Format Required'})
    class Meta:
        model = Supplier
        fields = ['name', 'phone', 'address', 'email', 'tin', 'gstin']
        widgets = {
